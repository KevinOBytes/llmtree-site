...
export const papers: PaperNode[] = [
  ...
  {
    id: "paper-prospective-credit",
    title: "Prospective Credit Assignment for Long-Horizon Task Planning",
    authors: "Google DeepMind",
    year: 2026,
    institution: "Google DeepMind",
    contribution: "Introduced a novel training approach that teaches AI models to anticipate the impact of current decisions on outcomes many steps into the future.",
    significance: "Significantly improved performance on complex software engineering benchmarks, pushing models toward robust long-horizon agentic capabilities.",
    parentIds: ["paper-chain-of-thought"],
    innovations: ["agentic", "reasoning"],
    era: "reasoning",
  },
  {
    id: "paper-self-correcting-reasoning",
    title: "Training Models to Self-Correct During Chain-of-Thought",
    authors: "MIT, Stanford",
    year: 2026,
    institution: "MIT, Stanford",
    contribution: "Demonstrated that the effectiveness of reasoning models heavily relies on training models to identify and fix errors during the reasoning process, rather than just raw scale.",
    significance: "Further solidified the 'test-time compute' paradigm by shifting focus from model size to self-correcting reasoning loops.",
    parentIds: ["paper-chain-of-thought", "paper-test-time-compute"],
    innovations: ["reasoning", "chain-of-thought", "test-time-compute"],
    era: "reasoning",
  },
  {
    id: "paper-openai-math-advances",
    title: "Ten Advances in Mathematics and Theoretical Computer Science",
    authors: "OpenAI Research",
    year: 2026,
    institution: "OpenAI",
    contribution: "Showcased AI solving complex mathematical problems with Lean-formalized proofs, achieving breakthroughs in problems that had seen no progress for decades.",
    significance: "Demonstrated AI's emerging capability to meaningfully contribute to frontier mathematics and theoretical research, beyond simply memorizing existing proofs.",
    parentIds: ["paper-chain-of-thought", "paper-alpha-proof"],
    relatedModelIds: ["model-gpt5.6", "model-o4-mini"],
    innovations: ["reasoning"],
    era: "reasoning",
  },
  {
    id: "paper-agentstream",
    title: "AgentStream: How Well Do Self-Evolving LLM Agents Perform Under Streaming Tasks?",
    authors: "Anonymous",
    year: 2026,
    institution: "Various",
    contribution: "Explored and benchmarked the performance of autonomous agents in continuously evolving, streaming task environments.",
    significance: "Reflected the industry's shift toward self-evolving autonomous agents that can manage multi-step workflows over extended periods.",
    parentIds: [],
    innovations: ["agentic"],
    era: "reasoning",
  },
